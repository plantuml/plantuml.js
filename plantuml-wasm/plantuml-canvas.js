const plantuml = (() => {
    const initialize = async (parentDisplayElement, cheerpjPath = "/app/plantuml-wasm") => {
        await Promise.all([
            ...
            cheerpjCreateDisplay(-1,-1, parentDisplayElement))
        ])
    ...
    const renderPng = (pumlContent) => {
        return new Promise((resolve, reject) => {
            cjCall("com.plantuml.wasm.Canvas", "convertCanvas", 450, 650, pumlContent).then((exitCode) => {
